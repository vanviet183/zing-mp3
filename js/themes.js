const Themes = [
    [
        {
            image:'img/themeBgs/listTheme1/theme1.svg',
            colors: {
            ...
            playerImage: 'img/themeBgs/listTheme1/playerThemes/theme1.png',
        },
        {
            image:'img/themeBgs/listTheme1/theme2.jpg',
            colors: {
                bgContentColor:"#ffffff1a",
                borderBox:"rgb(255 255 255 / 20%)",
                borderPrimary:"rgb(255 255 255 / 10%)",
    ...
    [
        {
            image:'img/themeBgs/listTheme2/theme1.jpg',
            colors: {
                bgContentColor:"#ffffff1a",
                borderBox:"rgb(255 255 255 / 20%)",
                borderPrimary:"rgb(255 255 255 / 10%)",
        ...
        {
            image:'img/themeBgs/listTheme2/theme2.jpg',
            colors: {
        ...
        {
            image:'img/themeBgs/listTheme2/theme3.jpg',
            colors: {
        ...
        {
            image:'img/themeBgs/listTheme2/theme4.jpg',
            colors: {
                bgContentColor:"rgba(0,0,0,0.05)",
                borderBox:"rgba(0,0,0,0.2)",
                borderPrimary:"rgba(0,0,0,0.1)",
        ...
        {
            image:'img/themeBgs/listTheme2/theme5.jpg',
            colors: {
                bgContentColor:"rgba(0,0,0,0.05)",
                borderBox:"rgba(0,0,0,0.2)",
                borderPrimary:"rgba(0,0,0,0.1)",
        ...
        {
            image:'img/themeBgs/listTheme2/theme6.jpg',
            colors: {
                bgContentColor:"rgba(0,0,0,0.05)",
                borderBox:"rgba(0,0,0,0.2)",
                borderPrimary:"rgba(0,0,0,0.1)",
